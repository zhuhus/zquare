<template>
  <z-teleport :disabled="!teleported" :to="appendTo">
    <transition
...
import { useNamespace, usePopperContainerId } from '@zquare/hooks'
import { castArray, composeEventHandlers, focusElement } from '@zquare/utils'
import { ZPopperContent } from '@zquare/components/popper'
import ZTeleport from '@zquare/components/teleport'
import { TOOLTIP_INJECTION_KEY } from './constants'
import { useTooltipContentProps } from './content'
import { isTriggerType } from './utils'

import type { PopperContentInstance } from '@zquare/components/popper'
