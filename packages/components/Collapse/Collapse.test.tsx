...
describe("Collapse.vue", () => {
  beforeAll(() => {
    ...
    headers = wrapper.findAll(".z-collapse-item__header");
    contents = wrapper.findAll(".z-collapse-item__wrapper");
  ...
  test("手风琴模式 错误处理", () => {
    ...
    expect(warn.mock.calls).toMatchInlineSnapshot(
     `
        [
          [
            [ZUIError: [ZCollapse] accordion mode should only have one active item],
          ],
        ]
      `
    );
