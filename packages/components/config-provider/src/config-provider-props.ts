...
import { useEmptyValuesProps, useSizeProp } from "@zquare/hooks";

import type { ExtractPropTypes, __ExtractPublicPropTypes } from "vue";
import type { Language } from "@zquare/locale";
import type { ButtonConfigContext } from "@zquare/components/button";
