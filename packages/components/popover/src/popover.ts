import { buildProps, isBoolean } from '@zquare/utils'
import {
  useTooltipContentProps,
  useTooltipTriggerProps,
} from '@zquare/components/tooltip'
// import { dropdownProps } from '@zquare/components/dropdown'
...
export const popoverProps = buildProps({
   ...
   */
  placement: useTooltipContentProps.placement,
  /**
   ...
   */
  //   tabindex: useTooltipContentProps.tabindex,
  /**
