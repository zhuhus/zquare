...
import { ZOnlyChild } from '@zquare/components/slot'
import { useForwardRef } from '@zquare/hooks'
import { isElement, isFocusable } from '@zquare/utils'
  ...
  watch(
    ...
    (el, prevEl) => {
      ...
      if (isElement(el)) {
        ...
        console.log(isFocusable(el as HTMLElement))
